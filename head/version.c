...
#ident "@(#) CSLiS version.c 7.111 2024-12-05 12:30:00 "


char	lis_version[] = "CS7111A" ;
char	lis_date[]    = "05 Dec 24" ;
...
2.19    Incorporated Paul Landry`s 64 bit/PPC/S390 code changes
	Several changes to fix SMP lockups/panics
	General 2.6 fixes; mostly portability related.
