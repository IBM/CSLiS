...
#ident "@(#) CSLiS port-mdep.c 7.11 2022-10-26 15:30:00 "
...
#else
void
lis_tmout(struct lis_timer_list *lis_tl, void (*fn)(ulong), long arg, long ticks)
{
    ...
    lis_tl->arg    = arg;
    lis_tl->tl.tdelta = ticks * (1000/HZ) ;
    port_add_timer(lis_tl->tl);
}
#endif
